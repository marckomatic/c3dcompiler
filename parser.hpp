  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_PARDER = 10,                           // PARDER
        S_POR = 11,                              // POR
        S_DIVIDIDO = 12,                         // DIVIDIDO
        S_PYCOMA = 13,                           // PYCOMA
        S_EVALUAR = 14,                          // EVALUAR
        S_MAYOR = 15,                            // MAYOR
        S_MENOR = 16,                            // MENOR
        S_MAYORIGUAL = 17,                       // MAYORIGUAL
        S_MENORIGUAL = 18,                       // MENORIGUAL
        S_YYACCEPT = 19,                         // $accept
        S_listasentencias = 20,                  // listasentencias
        S_sentencia = 21,                        // sentencia
        S_expresionComparativa = 22,             // expresionComparativa
        S_expresion = 23,                        // expresion
        S_expresion2 = 24                        // expresion2
      };
    };
