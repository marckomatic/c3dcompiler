...
%token <std::string>  NUMERO ID TRUE FALSE
// token de tipo por defecto
    //token por ID
%token SUMA MENOS PARIZQ PARDER POR DIVIDIDO PYCOMA EVALUAR MAYOR MENOR MAYORIGUAL MENORIGUAL
/*
forma alterna 
%token SUMA '+'
%token ID 'un_id'
...
%type< Proyecto1::Expresion* > expresion expresion2 expresionComparativa;
// printer
/*
...
sentencia : EVALUAR PARIZQ expresionComparativa PARDER PYCOMA
       {
...
expresionComparativa : expresionComparativa MAYOR expresion
    {
        $$ = new Proyecto1::Expresion($1, $3, '>');
    }
    | expresionComparativa MENOR expresion
    {
        $$ = new Proyecto1::Expresion($1, $3, '<');
    }
    | expresionComparativa MAYORIGUAL expresion
    {
        $$ = new Proyecto1::Expresion($1, $3, '>=');
    }
    | expresionComparativa MENORIGUAL expresion
    {
        $$ = new Proyecto1::Expresion($1, $3, '<=');
    }
    | expresion
...
expresion2 : expresion2 POR NUMERO
       ...
       | TRUE
       {
           $$ = new Proyecto1::Expresion(nullptr, nullptr, 't');
           $$->valor = $1;
       }
       | FALSE
       {
           $$ = new Proyecto1::Expresion(nullptr, nullptr, 'f');
           $$->valor = $1;
       }
